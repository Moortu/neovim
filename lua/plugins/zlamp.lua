-- ================================================================================================
-- TITLE : zig-lamp
-- ABOUT : Zig language support and ZLS (Zig Language Server) integration for Neovim
-- LINKS :
--   > github            : https://github.com/jinzhongjia/zig-lamp
--   > plenary.nvim (dep): https://github.com/nvim-lua/plenary.nvim
--   > nvim-lspconfig (dep): https://github.com/neovim/nvim-lspconfig
-- ================================================================================================
